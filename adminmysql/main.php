 ...
 */
?>
<h1><?php echo sprintf($strWelcome, ' DB_Sercomtel ' . PMA_VERSION); ?></h1>
...
<!-- MySQL and DB_Sercomtel related links -->
<table>
<tr>
...
/**
 * Displays the DB_Sercomtel related links
 */
?>

    <!-- DB_Sercomtel related links -->
    <td valign="top" align="<?php echo $cell_align_left; ?>">
        <table>
        <tr>
            <th colspan="2">&nbsp;&nbsp;DB_Sercomtel</th>
        </tr>
